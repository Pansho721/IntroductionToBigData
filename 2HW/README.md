...
**Due: October 8, 2025** 23:59 China time. Late submission results in lower (or even no) scores.
...
You must use `-n 1` for this lab, because the program only works in a single process.
...
If you have access, submit the ZIP file to the web learning homeworks. Otherwise, email the ZIP file to TA. You should submit before **October 8, 2025** 23:59 China time. Late submission results in lower (or even no) scores.
