...
**Due:  October 13, 2025** 23:59 China time. Late submission results in lower (or even no) scores.
...
If you have access, submit the ZIP file to the web learning homeworks. Otherwise, email the ZIP file to TA. You should submit before **October 13, 2025** 23:59 China time. Late submission results in lower (or even no) scores.
